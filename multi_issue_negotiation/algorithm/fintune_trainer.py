...
#
    def train_from_torch(self, batch):
        ...
        gt.stamp("fintune training", unique=False)
        return stats
    def updata_rl_agent(self):
        self.rl_agent.update_network(self.networks())
    ...
    def compute_loss(
        ...
        eval_statistics["weight_loss"] = weight_loss
    ...
    def save_model(self, filename, directory):
        ...
        for policy in policies:
            torch.save(policy.state_dict(), '%s/%s_actor.pt' % (directory, filename+"num"+str(num)))
